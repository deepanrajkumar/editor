...
const Notes = ({ setLoader }) => {
  ...
  return (
    <Container maxWidth="xl">
      <Grid container alignItems="stretch" direction="row" spacing={2} pt={2}>
        {list.map((data, index) => (
          <Grid container alignItems="stretch" item lg={3} key={index}>
            <Card
              sx={{
                display: "flex",
                flex: 1,
            ...
            >
              <CardContent>
                ...
                <Typography
                  ...
                  onClick={() => navigator.clipboard.writeText(data.note)}
                >
                  {data.note}
                </Typography>
                <Typography
